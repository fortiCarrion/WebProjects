var timerId = null; //variavel de armazenamento da funcao timeOut

function iniciaJogo() {

    var url = window.location.search; //search procura oq esta apos o sinal de interogacao
...
function situacao_jogo(baloes_inteiros) {
    if (baloes_inteiros == 0) {
        alert("Jogo concluido com sucesso");
        parar_jogo();
    }
}
